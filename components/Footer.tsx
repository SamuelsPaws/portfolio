...
import ContactItem from "./footer-sub/ContactItem"
  ...
  return (
    ...
    >
      ...
      <div className="
        ...
        bg-black"
      >
        <p className="text-xl lg:text-2xl text-mywhite tracking-wider">
          {t('contactMe')}
        </p>
        <ContactItem
        ...
        <ContactItem
          ...
          iconClass="fa-github scale-130"
          text="SamuelsPaws"
          newTab={true}
        />
        <ContactItem
          href="https://www.linkedin.com/in/samuel-baquero-779720231/"
          iconClass="fa-linkedin-square scale-120"
          text="Samuel Baquero"
          newTab={true}
        />
        <ContactItem
          href="https://www.instagram.com/samsausa/"
          iconClass="fa-instagram scale-120"
          text="samsausa"
          newTab={true}
        />
      </div>
